...
`,Yo=({children:e})=>i.createElement(Zo,null,i.Children.map(e,(t,n)=>i.createElement(Ro,{key:n},t))),Go={componentVariablesPath:"../../../../popoyoko-default-variables/web/ComponentPopoyoko"},Uo=async()=>{try{const e=`${Go.componentVariablesPath}`;console.log("Loading tokens from:",e);const t=await import(`${e}.ts`);return console.log("Loaded component tokens:",t.default),{componentTokens:t.default}}catch(e){throw console.error("Error loading tokens:",e),e}},Kt=i.createContext(void 0),Bo=({children:e})=>{const[t,n]=i.useState(null);return i.useEffect(()=>{(async()=>{try{const{componentTokens:o}=await Uo();n(o)}catch(o){console.error("Error loading tokens:",o)}})()},[]),t?i.createElement(Kt.Provider,{value:{componentTokens:t}},e):i.createElement("div",null,"Loading...")},Ho=()=>{const e=i.useContext(Kt);if(e===void 0)throw new Error("useTokens must be used within a TokenProvider");return e},Wo=({label:e})=>{const{componentTokens:t}=Ho(),n={Initial:t.ButtonPrimary.BG.Initial};return t?i.createElement("button",{style:{backgroundColor:n.Initial}},e):i.createElement("p",null,"no component tokens")};function Fo(e){return{name:"variables-config-plugin",transform(t,n){if(n.endsWith("tokens-config.ts")){const o=(void 0)((void 0)(n),(void 0)(e.tokenPath));return{code:t.replace(/componentVariablesPath:\s*".*?"/,`componentVariablesPath: '${o}'`)}}return null}}}exports.Avatar=ze;exports.Button=G;exports.Card=tt;exports.Header=oo;exports.Icon=m;exports.Information=io;exports.InputDate=zo;exports.InputDownload=Lo;exports.InputRadio=To;exports.InputSearch=Jt;exports.InputSelect=vo;exports.InputText=xo;exports.InputUpload=Qo;exports.Logo=Xt;exports.Ratio=ae;exports.Section=uo;exports.Slider=Yo;exports.TestButton=Wo;exports.Text=ho;exports.TokenProvider=Bo;exports.variablesConfigPlugin=Fo;

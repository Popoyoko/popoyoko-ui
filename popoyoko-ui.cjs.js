...
`,$r=l.p`
  ...
  font-weight: 700;
  line-height: normal;
`,Jr=({media:e="https://imgs.search.brave.com/eHBodvumUFQ7TzAM2YRFjFbE9P2IB_VeLxS5-sesWlo/rs:fit:860:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzA1Lzc5LzY4LzI0/LzM2MF9GXzU3OTY4/MjQ3OV9qNGpSZngw/bmwzQzh2TXJUWVZh/cEZuR1A4RWdOSGdm/ay5qcGc",title:t="",mention:n="",subTitle:r="",price:o=0})=>i.createElement(Ur,null,i.createElement(ae.L2H3,null,i.createElement(Br,{src:e,alt:e})),i.createElement(Hr,null,i.createElement(Dt,null,i.createElement(Fr,null,n),i.createElement(Wr,null,i.createElement(Dt,null,i.createElement(Vr,null,t),i.createElement(_r,null,r)),i.createElement($r,null,o))))),Xr=l.div`
  padding: 0px;
  width: auto;
  min-width: 246px;
`,Kr=l.img`
...
`,to=l.img`
  ...
  max-width: 48px;
  object-fit: cover;
`,Jt=({background:e})=>i.createElement(eo,null,i.createElement(to,{src:e})),no=l.form`
display: flex;
padding: 12px;
justify-content: space-between;
align-items: flex-start;
...
width: 100%;
outline: none;
`,Xt=({placeholder:e,onChange:t,onSubmit:n})=>{const r=o=>{o.preventDefault(),n&&n(o)};return i.createElement(no,{onSubmit:r},i.createElement(ro,{type:"search",placeholder:e,onChange:t}),i.createElement(m.Search,null))},oo=({brand:e,logoBackground:t,avatarBackground:n,onClick:r})=>i.createElement("div",null,i.createElement(Jt,{background:t}),i.createElement(Xt,{placeholder:""}),i.createElement(ze.Small,{background:n,onClick:r})),io=({label:e="Information"})=>i.createElement("div",null,i.createElement(m.Information,null),i.createElement("p",null,e)),ao=l.div`
  display: flex;
  padding: 32px 16px;
  flex-direction: column;
  align-items: flex-start;
...
`,Eo=l.label`
  ...
  text-align: start;
`,To=({label:e,name:t,value:n,checked:r,onChange:o})=>{const a=i.useId();return i.createElement(Do,null,i.createElement(No,{type:"radio",id:a,onChange:o,checked:r,name:t,value:n}),i.createElement(Eo,{htmlFor:a},e))},Ao=l.div`
  position: relative;
  display: flex;
...
`,Yo=({children:e})=>i.createElement(Zo,null,i.Children.map(e,(t,n)=>i.createElement(Ro,{key:n},t))),Go={componentVariablesPath:"../../builded/web/ComponentPopoyoko"},Uo=Go,Bo=async()=>{try{const e=`${Uo.componentVariablesPath}`;console.log("Loading tokens from:",e);const t=await import(`${e}.ts`);return console.log("Loaded component tokens:",t.default),{componentTokens:t.default}}catch(e){throw console.error("Error loading tokens:",e),e}},Kt=i.createContext(void 0),Ho=({children:e})=>{const[t,n]=i.useState(null);return i.useEffect(()=>{(async()=>{try{const{componentTokens:o}=await Bo();n(o)}catch(o){console.error("Error loading tokens:",o)}})()},[]),t?i.createElement(Kt.Provider,{value:{componentTokens:t}},e):i.createElement("div",null,"Loading...")},Wo=()=>{const e=i.useContext(Kt);if(e===void 0)throw new Error("useTokens must be used within a TokenProvider");return e},Fo=({label:e})=>{const{componentTokens:t}=Wo(),n={Initial:t.ButtonPrimary.BG.Initial};return t?i.createElement("button",{style:{backgroundColor:n.Initial}},e):i.createElement("p",null,"no component tokens")};function Vo(e){return{name:"variables-config-plugin",transform(t,n){if(n.endsWith("tokens-path.json")){console.log(`Transforming ${n}`);const o=(void 0)((void 0)(n),(void 0)(e.tokenPath));return{code:`export default ${JSON.stringify({componentVariablesPath:o},null,2)};`}}return null}}}exports.Avatar=ze;exports.Button=G;exports.Card=tt;exports.Header=oo;exports.Icon=m;exports.Information=io;exports.InputDate=zo;exports.InputDownload=Lo;exports.InputRadio=To;exports.InputSearch=Xt;exports.InputSelect=vo;exports.InputText=xo;exports.InputUpload=Qo;exports.Logo=Jt;exports.Ratio=ae;exports.Section=uo;exports.Slider=Yo;exports.TestButton=Fo;exports.Text=ho;exports.TokenProvider=Ho;exports.variablesConfigPlugin=Vo;

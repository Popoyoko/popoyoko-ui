...
padding: 8px;
width: fit-content;
`,G=({type:e="primary",label:t,typeSvg:n,children:r,onClick:o,value:a})=>{if(n==="none")return i.createElement(Ne,{className:e,onClick:o,value:a},i.createElement(Ye,null,t));if(n==="left")return i.createElement(Ne,{className:e,onClick:o,value:a},r,i.createElement(Ye,null,t));if(n==="right")return i.createElement(Ne,{className:e,onClick:o,value:a},i.createElement(Ye,null,t),r);if(n==="only")return i.createElement(dr,{className:e,onClick:o,value:a},r)};G.Primary=e=>i.createElement(G,{type:"primary",...e});G.Secondary=e=>i.createElement(G,{type:"secondary",...e});G.Tertiary=e=>i.createElement(G,{type:"tertiary",...e});const ur=c.div`
  position: relative;
  overflow: hidden;
`,gr=c(ur)`
  aspect-ratio: 1 / 1;
...
`,_r=c.img`
  max-height: 32px;
  max-width: 32px;
`,Bt=({src:e})=>i.createElement(Vr,null,i.createElement(_r,{src:e})),$r=c.div`
display: flex;
padding: 12px;
justify-content: space-between;
align-items: flex-start;
...
width: 100%;
outline: none;
`,Wt=({placeholder:e,onChange:t})=>i.createElement($r,null,i.createElement(Xr,{type:"search",placeholder:e,onChange:t}),i.createElement(m.Search,null)),Jr=c.div`
  display: flex;
`,Kr=()=>i.createElement(Jr,null,i.createElement(Bt,{src:""}),i.createElement(Wt,{placeholder:""}),i.createElement(Se.Small,null)),qr=c.div`
  display: flex;
  padding: 16px;
  align-items: flex-start;
  gap: 8px;
...
`,eo=c.p`
  ...
  line-height: 20px;
  margin: 0;
`,to=({label:e="Information",background:t="#2018b0"})=>{const n=c(qr)`
  background: ${t};
  `;return i.createElement(n,null,i.createElement(m.Information,null),i.createElement(eo,null,e))},no=c.div`
  display: flex;
  padding: 32px 16px;
  flex-direction: column;
  align-items: flex-start;
...
`,Eo=c.select`
  ...
  color: #0f082b;
  outline: none;
`,Ao=({label:e,options:t,name:n,value:r,onChange:o})=>i.createElement(Do,null,i.createElement(No,null,e),i.createElement(Eo,{value:r,onChange:o,name:n},t.map((a,s)=>i.createElement("option",{key:s,value:typeof a=="object"?a.value:a},typeof a=="object"?a.label:a)))),To=c.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  gap: 8px;

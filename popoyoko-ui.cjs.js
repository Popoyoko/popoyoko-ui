...
`,Yo=({children:e})=>i.createElement(Zo,null,i.Children.map(e,(t,n)=>i.createElement(Ro,{key:n},t))),Go="../../popoyoko-default-variables/web/ComponentPopoyoko",Uo={componentVariablesPath:Go},Bo=Uo,Ho=async()=>{try{const e=`${Bo.componentVariablesPath}`;console.log("Loading tokens from:",e);const t=await import(`${e}.ts`);return console.log("Loaded component tokens:",t.default),{componentTokens:t.default}}catch(e){throw console.error("Error loading tokens:",e),e}},Kt=i.createContext(void 0),Wo=({children:e})=>{const[t,n]=i.useState(null);return i.useEffect(()=>{(async()=>{try{const{componentTokens:o}=await Ho();n(o)}catch(o){console.error("Error loading tokens:",o)}})()},[]),t?i.createElement(Kt.Provider,{value:{componentTokens:t}},e):i.createElement("div",null,"Loading...")},Fo=()=>{const e=i.useContext(Kt);if(e===void 0)throw new Error("useTokens must be used within a TokenProvider");return e},Vo=({label:e})=>{const{componentTokens:t}=Fo(),n={Initial:t.ButtonPrimary.BG.Initial};return t?i.createElement("button",{style:{backgroundColor:n.Initial}},e):i.createElement("p",null,"no component tokens")};function _o(e){return{name:"variables-config-plugin",load(t){return t.endsWith("tokens-path.json")?(console.log(`Using tokenPath from user config: ${e.tokenPath}`),{code:JSON.stringify({componentVariablesPath:e.tokenPath},null,2),map:null}):null}}}exports.Avatar=ze;exports.Button=G;exports.Card=tt;exports.Header=oo;exports.Icon=m;exports.Information=io;exports.InputDate=zo;exports.InputDownload=Lo;exports.InputRadio=To;exports.InputSearch=Xt;exports.InputSelect=vo;exports.InputText=xo;exports.InputUpload=Qo;exports.Logo=Jt;exports.Ratio=ae;exports.Section=uo;exports.Slider=Yo;exports.TestButton=Vo;exports.Text=ho;exports.TokenProvider=Wo;exports.variablesConfigPlugin=_o;

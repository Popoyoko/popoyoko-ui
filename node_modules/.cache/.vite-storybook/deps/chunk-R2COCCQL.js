...
function getAllLineNumbers(_ref) {
  ...
  return lines.map(function(_, i) {
    ...
    return import_react2.default.createElement("span", { key: "line-".concat(i), className: "react-syntax-highlighter-line-number", style: typeof style == "function" ? style(number) : style }, "".concat(number, `
`));
  });
}
function AllLineNumbers(_ref2) {
  ...
  return import_react2.default.createElement("code", { style: Object.assign({}, codeStyle, containerStyle) }, getAllLineNumbers({ lines: codeString.replace(/\n$/, "").split(`
...
function highlight_default(defaultAstGenerator, defaultStyle) {
  return function(_ref7) {
    ...
    return import_react2.default.createElement(PreTag, preProps, import_react2.default.createElement(CodeTag, codeTagProps, !showInlineLineNumbers && allLineNumbers, renderer({ rows, stylesheet: style, useInlineStyles })));
  };
}
...
var ActionBar = ({ actionItems, ...props }) => import_react4.default.createElement(Container, { ...props }, actionItems.map(({ title, className, onClick, disabled }, index) => import_react4.default.createElement(ActionButton, { key: index, className, onClick, disabled }, title)));
var GlobalScrollAreaStyles = (0, import_react5.lazy)(() => import("./GlobalScrollAreaStyles-XIHNDKUY-HCIWI2QY.js"));
var OverlayScrollbars = (0, import_react5.lazy)(() => import("./OverlayScrollbars-VAV6LJAB-2JGIA2GH.js"));
var Scroller = ({ horizontal, vertical, ...props }) => import_react5.default.createElement(import_react5.Suspense, { fallback: import_react5.default.createElement("div", { ...props }) }, import_react5.default.createElement(GlobalScrollAreaStyles, null), import_react5.default.createElement(OverlayScrollbars, { options: { scrollbars: { autoHide: "leave" } }, ...props }));
...
//# sourceMappingURL=chunk-R2COCCQL.js.map

...
Content-Disposition: form-data; name="`;return F.forEach((v,n)=>typeof v=="string"?c.push(p+e(n)+`"\r
\r
${v.replace(/\r(?!\n)|(?<!\r)\n/g,`\r
`)}\r
...
\r
`,v,`\r
`)),c.push(`--${b}--`),new B(c,{type:"multipart/form-data; boundary="+b})}__toESM(require_node_domexception(),1);

export { FormData, __require, fetch_blob_default, file_default, formDataToBlob };

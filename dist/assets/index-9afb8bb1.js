...
function nu(e, n, t, r) {
  if (jr) {
    var l = po(e, n, t, r);
    if (l === null) Dl(e, n, r, Ir, t), Gu(e, r);
...
function Lf(e, n) {
  if (jn)
    return e === "compositionend" || (!ou && Ds(e, n))
      ? ((e = Os()), (kr = tu = en = null), (jn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function oi() {
  xt && (xt.detachEvent("onpropertychange", Us), (Ft = xt = null));
}
function Us(e) {
  if (e.propertyName === "value" && rl(Ft)) {
    var n = [];
    Is(n, Ft, e, Jo(e)), ys(Rf, n);
  }
}
function Mf(e, n, t) {
  e === "focusin"
    ? (oi(), (xt = n), (Ft = t), xt.attachEvent("onpropertychange", Us))
    : e === "focusout" && oi();
}
function Df(e) {
...
function vn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), ks(qo, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function dr(e) {
  ...
  if (
    ...
    if (Eo(e)) throw (bs(), Error(y(418)));
    for (; n; ) qs(e, n), (n = on(n.nextSibling));
  }
  if ((gi(e), e.tag === 13)) {
...
function No(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ta), mu(e);
  var o = n.contextType;
  typeof o == "object" && o !== null
    ? (l.context = _e(o))
    : ((o = de(n) ? xn : le.current), (l.context = bn(e, o))),
...
function la(e) {
  ...
  function S(f, a, d, h) {
    ...
    if (T.done) return t(f, x), F && gn(f, N), E;
    if (x === null) {
...
function Ri(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Nr(e, n), ra(n, t, r), No(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function id(e, n, t, r, l, o, u) {
  ...
  if (((i = (u & e.childLanes) !== 0), ce || i)) {
    ...
    return Lu(), (r = Vl(Error(y(421)))), mr(e, n, u, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function ad(e, n, t) {
  ...
  switch ((su(n), n.tag)) {
    ...
    case 4:
      return (
        tt(), Oo(e, n), e === null && $t(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[So], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Xu(t), n === 1))
      e.tag === 0 ? Zf(Ai.bind(null, e)) : Zs(Ai.bind(null, e)),
        Kf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
Xa = function (e, n, t) {
  ...
  else (ce = !1), F && n.flags & 1048576 && Js(n, Br, n.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            No(n, r, e, t),
            (n = Lo(null, n, r, !0, o, t)))
          : ((n.tag = 0), F && o && iu(n), oe(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (bo(n, t | 1), pe(n, W()), !(R & 6) && ((lt = W() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
vs = Pu;
hs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, ps, ms, Pu] },
  yt = {
...
const Td = "/assets/react-35ef61ed.svg",
  Rd = "/vite.svg";
function Od() {
  const [e, n] = Jn.useState(0);
  return te.jsxs("div", {
    className: "App",
    children: [
      te.jsxs("div", {
      ...
      te.jsxs("div", {
        ...
        children: [
          ...
          te.jsxs("p", {
            children: [
              "Edit ",
              te.jsx("code", { children: "src/App.tsx" }),
...
Ql.createRoot(document.getElementById("root")).render(
  te.jsx(gc.StrictMode, { children: te.jsx(Od, {}) })
);

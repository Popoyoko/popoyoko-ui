...
`,Pr={Add:Nr,AddPicture:Dr,ArrowBottom:wr,ArrowLeft:Er,ArrowRight:Ar,ArrowTop:Tr,ArrowTriangle:br,DateFlat:Cr,DateLine:jr,Information:vr,Search:Sr,Upload:$t,UserFlat:zr,UserLine:kr},f=({size:e="medium",icon:t})=>{const n=`icon-${e} icon`,r=Pr[t];return i.createElement(Or,{className:n},i.createElement(Lr,{src:r,alt:t}))};f.Add=e=>i.createElement(f,{icon:"Add",...e});f.AddPicture=e=>i.createElement(f,{icon:"AddPicture",...e});f.ArrowBottom=e=>i.createElement(f,{icon:"ArrowBottom",...e});f.ArrowLeft=e=>i.createElement(f,{icon:"ArrowLeft",...e});f.ArrowRight=e=>i.createElement(f,{icon:"ArrowRight",...e});f.ArrowTop=e=>i.createElement(f,{icon:"ArrowTop",...e});f.ArrowTriangle=e=>i.createElement(f,{icon:"ArrowTriangle",...e});f.DateFlat=e=>i.createElement(f,{icon:"DateFlat",...e});f.DateLine=e=>i.createElement(f,{icon:"DateLine",...e});f.Information=e=>i.createElement(f,{icon:"Information",...e});f.Search=e=>i.createElement(f,{icon:"Search",...e});f.Upload=e=>i.createElement(f,{icon:"Upload",...e});f.UserFlat=e=>i.createElement(f,{icon:"UserFlat",...e});f.UserLine=e=>i.createElement(f,{icon:"UserLine",...e});const Qr=l.div.withConfig({displayName:"CoverContainer",componentId:"sc-42hjwm"})`
  position: relative;
...
`,Oo=({label:e,icon:t})=>i.createElement("form",null,i.createElement(zo,{htmlFor:"file-input"},t==="left"&&i.createElement("img",{src:Dt,alt:"download"}),e,t==="right"&&i.createElement("img",{src:Dt,alt:"download"}),i.createElement(ko,{type:"file",name:"file",id:"file-input"}))),Lo=l.button.withConfig({displayName:"ButtonUpload",componentId:"sc-6i551a"})`
  ...
  border-radius: 2px;
  width: 100%;
`,Po=({label:e,name:t,acceptedExtensions:n=".jpg,.png,.pdf"})=>{const r=i.useRef(null),[o,a]=i.useState(null),s=c=>{const g=c.target.files&&c.target.files[0];a(g)},d=()=>{r.current&&r.current.click()};return i.createElement(i.Fragment,null,i.createElement("input",{type:"file",accept:n,style:{display:"none"},ref:r,onChange:s}),i.createElement(Lo,{onClick:d,name:t},o?o.name:e,i.createElement("img",{src:$t,alt:"upload"})))},Qo=l.div.withConfig({displayName:"SliderContainer",componentId:"sc-1ljso4k"})`
position: relative;
  display: flex;
  align-items: flex-start;
  gap: 17px;

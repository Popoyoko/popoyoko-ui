...
import {
  require_doctrine
} from "./chunk-3GBVF7AK.js";
import {
  require_client
} from "./chunk-WYLNEF7E.js";
import {
  scope
...
var import_preview_api3 = __toESM(require_preview_api(), 1);
...
var import_preview_api4 = __toESM(require_preview_api(), 1);
...
var import_preview_api5 = __toESM(require_preview_api(), 1);
var import_preview_api6 = __toESM(require_preview_api(), 1);
var import_channels = __toESM(require_channels(), 1);
var import_preview_api7 = __toESM(require_preview_api(), 1);
...
var SourceSkeletonPlaceholder = emotion_styled_browser_esm_default.div(({ theme }) => ({ animation: `${theme.animation.glow} 1.5s ease-in-out infinite`, background: theme.appBorderColor, height: 17, marginTop: 1, width: "60%", ["&:first-child"]: { margin: 0 } }));
...
var DocsPageWrapper = ({ children }) => import_react3.default.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, import_react3.default.createElement(DocsContent, { className: "sbdocs sbdocs-content" }, children));
...
var Zoom2 = ({ zoom, resetZoom }) => import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement(IconButton, { key: "zoomin", onClick: (e) => {
  e.preventDefault(), zoom(0.8);
}, title: "Zoom in" }, import_react5.default.createElement(Icons, { icon: "zoom" })), import_react5.default.createElement(IconButton, { key: "zoomout", onClick: (e) => {
  e.preventDefault(), zoom(1.25);
}, title: "Zoom out" }, import_react5.default.createElement(Icons, { icon: "zoomout" })), import_react5.default.createElement(IconButton, { key: "zoomreset", onClick: (e) => {
  e.preventDefault(), resetZoom();
}, title: "Reset zoom" }, import_react5.default.createElement(Icons, { icon: "zoomreset" })));
var Bar = emotion_styled_browser_esm_default(FlexBar)({ position: "absolute", left: 0, right: 0, top: 0, transition: "transform .2s linear" });
var Toolbar = ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) => import_react5.default.createElement(Bar, { ...rest }, import_react5.default.createElement(import_react5.Fragment, { key: "left" }, isLoading ? [1, 2, 3].map((key) => import_react5.default.createElement(IconButtonSkeleton, { key })) : import_react5.default.createElement(Zoom2, { zoom, resetZoom })));
var ZoomContext = (0, import_react6.createContext)({ scale: 1 });
var { window: globalWindow } = scope;
var IFrame = class extends import_react8.Component {
  constructor() {
    super(...arguments);
    this.iframe = null;
  }
  ...
  render() {
    ...
    return import_react8.default.createElement("iframe", { id, title, src, ...allowFullScreen ? { allow: "fullscreen" } : {}, loading: "lazy", ...rest });
  }
};
...
var InlineStory = (props) => {
  let storyRef = (0, import_react7.useRef)(), [showLoader, setShowLoader] = (0, import_react7.useState)(true), [error, setError] = (0, import_react7.useState)(), { story, height, autoplay, forceInitialArgs, renderStoryToElement } = props;
  ...
  return error ? import_react7.default.createElement("pre", null, import_react7.default.createElement(ErrorFormatter, { error })) : import_react7.default.createElement(import_react7.default.Fragment, null, height ? import_react7.default.createElement("style", null, `${storyBlockIdFromId(props)} { min-height: ${height}; transform: translateZ(0); overflow: auto }`) : null, showLoader && import_react7.default.createElement(StorySkeleton, null), import_react7.default.createElement("div", { ref: storyRef, id: `${storyBlockIdFromId(props)}-inner`, "data-name": story.name, dangerouslySetInnerHTML: { __html: htmlContents } }));
};
var IFrameStory = ({ story, height = "500px" }) => import_react7.default.createElement("div", { style: { width: "100%", height } }, import_react7.default.createElement(ZoomContext.Consumer, null, ({ scale }) => import_react7.default.createElement(IFrame, { key: "iframe", id: `iframe--${story.id}`, title: story.name, src: getStoryHref(BASE_URL, story.id, { viewMode: "story" }), allowFullScreen: true, scale, style: { width: "100%", height: "100%", border: "0 none" } })));
var Story = (props) => {
  let { inline } = props;
  return import_react7.default.createElement("div", { id: storyBlockIdFromId(props), className: "sb-story sb-unstyled" }, inline ? import_react7.default.createElement(InlineStory, { ...props }) : import_react7.default.createElement(IFrameStory, { ...props }));
};
var StorySkeleton = () => import_react7.default.createElement(Loader, null);
...
var getSource = (withSource, expanded, setExpanded) => {
  switch (true) {
    ...
    case expanded:
      return { source: import_react4.default.createElement(StyledSource, { ...withSource, dark: true }), actionItem: { title: "Hide code", className: "docblock-code-toggle docblock-code-toggle--expanded", onClick: () => setExpanded(false) } };
    default:
      return { source: import_react4.default.createElement(StyledSource, { ...withSource, dark: true }), actionItem: { title: "Show code", className: "docblock-code-toggle", onClick: () => setExpanded(true) } };
  }
};
function getStoryId(children) {
  if (import_react4.Children.count(children) === 1) {
    let elt = children;
    if (elt.props)
      return elt.props.id;
  }
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react4.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react4.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react4.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react4.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-SECFZQ5X.js");
  ...
  return import_react4.default.createElement(PreviewContainer, { withSource, withToolbar, ...props, className: previewClasses.join(" ") }, withToolbar && import_react4.default.createElement(PositionedToolbar, { isLoading, border: true, zoom: (z) => setScale(scale * z), resetZoom: () => setScale(1), storyId: getStoryId(children), baseUrl: "./iframe.html" }), import_react4.default.createElement(ZoomContext.Provider, { value: { scale } }, import_react4.default.createElement(Relative, { className: "docs-story", onCopyCapture: withSource && onCopyCapture }, import_react4.default.createElement(ChildrenContainer, { isColumn: isColumn || !Array.isArray(children), columns, layout }, import_react4.default.createElement(Zoom.Element, { scale }, Array.isArray(children) ? children.map((child, i) => import_react4.default.createElement("div", { key: i }, child)) : import_react4.default.createElement("div", null, children))), import_react4.default.createElement(ActionBar, { actionItems }))), withSource && expanded && source);
};
var StyledPreview = emotion_styled_browser_esm_default(Preview)(() => ({ ".docs-story": { paddingTop: 32, paddingBottom: 40 } }));
var PreviewSkeleton = () => import_react4.default.createElement(StyledPreview, { isLoading: true, withToolbar: true }, import_react4.default.createElement(StorySkeleton, null));
...
var ArgJsDoc = ({ tags }) => {
  ...
  return !hasDisplayableParams && !hasDisplayableReturns && !hasDisplayableDeprecated ? null : import_react11.default.createElement(import_react11.default.Fragment, null, import_react11.default.createElement(Table, null, import_react11.default.createElement("tbody", null, hasDisplayableDeprecated && import_react11.default.createElement("tr", { key: "deprecated" }, import_react11.default.createElement("td", { colSpan: 2 }, import_react11.default.createElement("strong", null, "Deprecated"), ": ", tags.deprecated)), hasDisplayableParams && params.map((x) => import_react11.default.createElement("tr", { key: x.name }, import_react11.default.createElement("td", null, import_react11.default.createElement("code", null, x.name)), import_react11.default.createElement("td", null, x.description))), hasDisplayableReturns && import_react11.default.createElement("tr", { key: "returns" }, import_react11.default.createElement("td", null, import_react11.default.createElement("code", null, "Returns")), import_react11.default.createElement("td", null, tags.returns.description)))));
};
...
var EmptyArg = () => import_react12.default.createElement("span", null, "-");
var ArgText = ({ text, simple }) => import_react12.default.createElement(Text, { simple }, text);
...
var renderSummaryItems = (summaryItems, isExpanded = true) => {
  ...
  return isExpanded || (items = summaryItems.slice(0, ITEMS_BEFORE_EXPANSION)), items.map((item) => import_react12.default.createElement(ArgText, { key: item, text: item === "" ? '""' : item }));
};
var ArgSummary = ({ value: value2, initialExpandedArgs }) => {
  let { summary, detail } = value2, [isOpen, setIsOpen] = (0, import_react12.useState)(false), [isExpanded, setIsExpanded] = (0, import_react12.useState)(initialExpandedArgs || false);
  if (summary == null)
    return null;
  let summaryAsString = typeof summary.toString == "function" ? summary.toString() : summary;
  if (detail == null) {
    if (/[(){}[\]<>]/.test(summaryAsString))
      return import_react12.default.createElement(ArgText, { text: summaryAsString });
    let summaryItems = getSummaryItems(summaryAsString), itemsCount = summaryItems.length;
    return itemsCount > ITEMS_BEFORE_EXPANSION ? import_react12.default.createElement(Summary, { isExpanded }, renderSummaryItems(summaryItems, isExpanded), import_react12.default.createElement(ExpandButton, { onClick: () => setIsExpanded(!isExpanded) }, isExpanded ? "Show less..." : `Show ${itemsCount - ITEMS_BEFORE_EXPANSION} more...`)) : import_react12.default.createElement(Summary, null, renderSummaryItems(summaryItems));
  }
  return import_react12.default.createElement(WithTooltipPure, { closeOnOutsideClick: true, placement: "bottom", visible: isOpen, onVisibleChange: (isVisible) => {
    setIsOpen(isVisible);
  }, tooltip: import_react12.default.createElement(Detail, { width: calculateDetailWidth(detail) }, import_react12.default.createElement(SyntaxHighlighter2, { language: "jsx", format: false }, detail)) }, import_react12.default.createElement(Expandable, { className: "sbdocs-expandable" }, import_react12.default.createElement("span", null, summaryAsString), import_react12.default.createElement(ArrowIcon, { icon: isOpen ? "arrowup" : "arrowdown" })));
};
var ArgValue = ({ value: value2, initialExpandedArgs }) => value2 == null ? import_react12.default.createElement(EmptyArg, null) : import_react12.default.createElement(ArgSummary, { value: value2, initialExpandedArgs });
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus }) => {
  let onSetFalse = (0, import_react15.useCallback)(() => onChange(false), [onChange]);
  if (value2 === void 0)
    return import_react15.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onSetFalse }, "Set boolean");
  let controlId = getControlId(name), parsedValue = typeof value2 == "string" ? parse(value2) : value2;
  return import_react15.default.createElement(Label, { htmlFor: controlId, title: parsedValue ? "Change to false" : "Change to true" }, import_react15.default.createElement("input", { id: controlId, type: "checkbox", onChange: (e) => onChange(e.target.checked), checked: parsedValue, name, onBlur, onFocus }), import_react15.default.createElement("span", null, "False"), import_react15.default.createElement("span", null, "True"));
};
...
var DateControl = ({ name, value: value2, onChange, onFocus, onBlur }) => {
  let [valid, setValid] = (0, import_react16.useState)(true), dateRef = (0, import_react16.useRef)(), timeRef = (0, import_react16.useRef)();
  ...
  return import_react16.default.createElement(FlexSpaced, null, import_react16.default.createElement(Form.Input, { type: "date", max: "9999-12-31", ref: dateRef, id: `${controlId}-date`, name: `${controlId}-date`, onChange: onDateChange, onFocus, onBlur }), import_react16.default.createElement(Form.Input, { type: "time", id: `${controlId}-time`, name: `${controlId}-time`, ref: timeRef, onChange: onTimeChange, onFocus, onBlur }), valid ? null : import_react16.default.createElement("div", null, "invalid"));
};
...
var NumberControl = ({ name, value: value2, onChange, min, max, step, onBlur, onFocus }) => {
  let [inputValue, setInputValue] = (0, import_react17.useState)(typeof value2 == "number" ? value2 : ""), [forceVisible, setForceVisible] = (0, import_react17.useState)(false), [parseError, setParseError] = (0, import_react17.useState)(null), handleChange = (0, import_react17.useCallback)((event) => {
  ...
  }, [onChange, setParseError]), onForceVisible = (0, import_react17.useCallback)(() => {
    setInputValue("0"), onChange(0), setForceVisible(true);
  }, [setForceVisible]), htmlElRef = (0, import_react17.useRef)(null);
  return (0, import_react17.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]), (0, import_react17.useEffect)(() => {
    inputValue !== (typeof value2 == "number" ? value2 : "") && setInputValue(value2);
  }, [value2]), !forceVisible && value2 === void 0 ? import_react17.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set number") : import_react17.default.createElement(Wrapper2, null, import_react17.default.createElement(Form.Input, { ref: htmlElRef, id: getControlId(name), type: "number", onChange: handleChange, size: "flex", placeholder: "Edit number...", value: inputValue, valid: parseError ? "error" : null, autoFocus: forceVisible, name, min, max, step, onFocus, onBlur }));
};
...
var CheckboxControl = ({ name, options, value: value2, onChange, isInline }) => {
  if (!options)
    return import_client_logger2.logger.warn(`Checkbox with no options: ${name}`), import_react19.default.createElement(import_react19.default.Fragment, null, "-");
  let initial = selectedKeys(value2, options), [selected, setSelected] = (0, import_react19.useState)(initial), handleChange = (e) => {
  ...
  return import_react19.default.createElement(Wrapper3, { isInline }, Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return import_react19.default.createElement(Label2, { key: id, htmlFor: id }, import_react19.default.createElement("input", { type: "checkbox", id, name: id, value: key, onChange: handleChange, checked: selected == null ? void 0 : selected.includes(key) }), import_react19.default.createElement(Text2, null, key));
  }));
};
...
var RadioControl = ({ name, options, value: value2, onChange, isInline }) => {
  if (!options)
    return import_client_logger3.logger.warn(`Radio with no options: ${name}`), import_react20.default.createElement(import_react20.default.Fragment, null, "-");
  let selection = selectedKey(value2, options), controlId = getControlId(name);
  return import_react20.default.createElement(Wrapper4, { isInline }, Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return import_react20.default.createElement(Label3, { key: id, htmlFor: id }, import_react20.default.createElement("input", { type: "radio", id, name: id, value: key, onChange: (e) => onChange(options[e.currentTarget.value]), checked: key === selection }), import_react20.default.createElement(Text3, null, key));
  }));
};
...
var SingleSelect = ({ name, value: value2, options, onChange }) => {
  ...
  return import_react21.default.createElement(SelectWrapper, null, import_react21.default.createElement(Icons, { icon: "arrowdown" }), import_react21.default.createElement(OptionsSelect, { id: controlId, value: selection, onChange: handleChange }, import_react21.default.createElement("option", { key: "no-selection", disabled: true }, NO_SELECTION), Object.keys(options).map((key) => import_react21.default.createElement("option", { key }, key))));
};
var MultiSelect = ({ name, value: value2, options, onChange }) => {
  ...
  return import_react21.default.createElement(SelectWrapper, null, import_react21.default.createElement(OptionsSelect, { id: controlId, multiple: true, value: selection, onChange: handleChange }, Object.keys(options).map((key) => import_react21.default.createElement("option", { key }, key))));
};
var SelectControl = (props) => {
  let { name, options } = props;
  return options ? props.isMulti ? import_react21.default.createElement(MultiSelect, { ...props }) : import_react21.default.createElement(SingleSelect, { ...props }) : (import_client_logger4.logger.warn(`Select with no options: ${name}`), import_react21.default.createElement(import_react21.default.Fragment, null, "-"));
};
...
var OptionsControl = (props) => {
  ...
  if (Control)
    return import_react18.default.createElement(Control, { ...normalized });
...
var JsonAddValue = class extends import_react24.Component {
  constructor(props) {
  ...
  render() {
    let { handleCancel, onlyValue, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep } = this.props, addButtonElementLayout = (0, import_react24.cloneElement)(addButtonElement, { onClick: this.onSubmit }), cancelButtonElementLayout = (0, import_react24.cloneElement)(cancelButtonElement, { onClick: handleCancel }), inputElementValue = inputElementGenerator(VALUE, keyPath, deep), inputElementValueLayout = (0, import_react24.cloneElement)(inputElementValue, { placeholder: "Value", ref: this.refInputValue }), inputElementKeyLayout = null;
    if (!onlyValue) {
      let inputElementKey = inputElementGenerator(KEY, keyPath, deep);
      inputElementKeyLayout = (0, import_react24.cloneElement)(inputElementKey, { placeholder: "Key", ref: this.refInputKey });
    }
    return import_react24.default.createElement("span", { className: "rejt-add-value-node" }, inputElementKeyLayout, inputElementValueLayout, cancelButtonElementLayout, addButtonElementLayout);
  }
};
JsonAddValue.defaultProps = { onlyValue: false, addButtonElement: import_react24.default.createElement("button", null, "+"), cancelButtonElement: import_react24.default.createElement("button", null, "c") };
var JsonArray = class extends import_react24.Component {
  constructor(props) {
    super(props);
  ...
  renderCollapsed() {
    let { name, data, keyPath, deep } = this.state, { handleRemove, readOnly, getStyle, dataType, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name, data, keyPath, deep, dataType), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = (0, import_react24.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus });
    return import_react24.default.createElement("span", { className: "rejt-collapsed" }, import_react24.default.createElement("span", { className: "rejt-collapsed-text", style: collapsed, onClick: this.handleCollapseMode }, "[...] ", data.length, " ", data.length === 1 ? "item" : "items"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, addFormVisible, nextDeep } = this.state, { isCollapsed, handleRemove, onDeltaUpdate, readOnly, getStyle, dataType, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser } = this.props, { minus, plus, delimiter, ul, addForm } = getStyle(name, data, keyPath, deep, dataType), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = (0, import_react24.cloneElement)(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus }), removeItemButton = (0, import_react24.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus }), onlyValue = true, startObject = "[", endObject = "]";
    return import_react24.default.createElement("span", { className: "rejt-not-collapsed" }, import_react24.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !addFormVisible && addItemButton, import_react24.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, data.map((item, index) => import_react24.default.createElement(JsonNode, { key: index, name: `${index}`, data: item, keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveItem(index), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser }))), !isReadOnly && addFormVisible && import_react24.default.createElement("div", { className: "rejt-add-form", style: addForm }, import_react24.default.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, onlyValue, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser })), import_react24.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, endObject), !isReadOnly && removeItemButton);
  }
  render() {
    ...
    return import_react24.default.createElement("div", { className: "rejt-array-node" }, import_react24.default.createElement("span", { onClick: this.handleCollapseMode }, import_react24.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " ")), value2);
  }
};
JsonArray.defaultProps = { keyPath: [], deep: 0, minusMenuElement: import_react24.default.createElement("span", null, " - "), plusMenuElement: import_react24.default.createElement("span", null, " + ") };
var JsonFunctionValue = class extends import_react24.Component {
  constructor(props) {
    super(props);
    let keyPath = [...props.keyPath, props.name];
  ...
  render() {
    ...
    if (editEnabled && !resultOnlyResult) {
      let textareaElement = textareaElementGenerator(VALUE, comeFromKeyPath, deep, name, originalValue, dataType), editButtonElementLayout = (0, import_react24.cloneElement)(editButtonElement, { onClick: this.handleEdit }), cancelButtonElementLayout = (0, import_react24.cloneElement)(cancelButtonElement, { onClick: this.handleCancelEdit }), textareaElementLayout = (0, import_react24.cloneElement)(textareaElement, { ref: this.refInput, defaultValue: originalValue });
      result = import_react24.default.createElement("span", { className: "rejt-edit-form", style: style.editForm }, textareaElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout), minusElement = null;
    } else {
      result = import_react24.default.createElement("span", { className: "rejt-value", style: style.value, onClick: resultOnlyResult ? null : this.handleEditMode }, value2);
      let minusMenuLayout = (0, import_react24.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: style.minus });
      minusElement = resultOnlyResult ? null : minusMenuLayout;
    }
    return import_react24.default.createElement("li", { className: "rejt-function-value-node", style: style.li }, import_react24.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " "), result, minusElement);
  }
};
JsonFunctionValue.defaultProps = { keyPath: [], deep: 0, handleUpdateValue: () => {
}, editButtonElement: import_react24.default.createElement("button", null, "e"), cancelButtonElement: import_react24.default.createElement("button", null, "c"), minusMenuElement: import_react24.default.createElement("span", null, " - ") };
var JsonNode = class extends import_react24.Component {
  constructor(props) {
  ...
  render() {
    ...
    switch (dataType) {
      ...
      case STRING:
        return import_react24.default.createElement(JsonValue, { name, value: `"${data}"`, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NUMBER:
        return import_react24.default.createElement(JsonValue, { name, value: data, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case BOOLEAN:
        return import_react24.default.createElement(JsonValue, { name, value: data ? "true" : "false", originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case DATE:
        return import_react24.default.createElement(JsonValue, { name, value: data.toISOString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NULL:
        return import_react24.default.createElement(JsonValue, { name, value: "null", originalValue: "null", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case UNDEFINED:
        return import_react24.default.createElement(JsonValue, { name, value: "undefined", originalValue: "undefined", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case FUNCTION:
        return import_react24.default.createElement(JsonFunctionValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, textareaElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case SYMBOL:
        return import_react24.default.createElement(JsonValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      default:
        return null;
    }
  }
...
var JsonObject = class extends import_react24.Component {
  constructor(props) {
    super(props);
  ...
  renderCollapsed() {
    let { name, keyPath, deep, data } = this.state, { handleRemove, readOnly, dataType, getStyle, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = (0, import_react24.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus });
    return import_react24.default.createElement("span", { className: "rejt-collapsed" }, import_react24.default.createElement("span", { className: "rejt-collapsed-text", style: collapsed, onClick: this.handleCollapseMode }, "{...}", " ", keyList.length, " ", keyList.length === 1 ? "key" : "keys"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, nextDeep, addFormVisible } = this.state, { isCollapsed, handleRemove, onDeltaUpdate, readOnly, getStyle, dataType, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser } = this.props, { minus, plus, addForm, ul, delimiter } = getStyle(name, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = (0, import_react24.cloneElement)(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus }), removeItemButton = (0, import_react24.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus }), list = keyList.map((key) => import_react24.default.createElement(JsonNode, { key, name: key, data: data[key], keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveValue(key), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser })), startObject = "{", endObject = "}";
    return import_react24.default.createElement("span", { className: "rejt-not-collapsed" }, import_react24.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !isReadOnly && addItemButton, import_react24.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, list), !isReadOnly && addFormVisible && import_react24.default.createElement("div", { className: "rejt-add-form", style: addForm }, import_react24.default.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser })), import_react24.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, endObject), !isReadOnly && removeItemButton);
  }
  render() {
    ...
    return import_react24.default.createElement("div", { className: "rejt-object-node" }, import_react24.default.createElement("span", { onClick: this.handleCollapseMode }, import_react24.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " ")), value2);
  }
};
JsonObject.defaultProps = { keyPath: [], deep: 0, minusMenuElement: import_react24.default.createElement("span", null, " - "), plusMenuElement: import_react24.default.createElement("span", null, " + ") };
var JsonValue = class extends import_react24.Component {
  constructor(props) {
    super(props);
    let keyPath = [...props.keyPath, props.name];
    this.state = { value: props.value, name: props.name, keyPath, deep: props.deep, editEnabled: false, inputRef: null }, this.handleEditMode = this.handleEditMode.bind(this), this.refInput = this.refInput.bind(this), this.handleCancelEdit = this.handleCancelEdit.bind(this), this.handleEdit = this.handleEdit.bind(this), this.onKeydown = this.onKeydown.bind(this);
  ...
  render() {
    let { name, value: value2, editEnabled, keyPath, deep } = this.state, { handleRemove, originalValue, readOnly, dataType, getStyle, editButtonElement, cancelButtonElement, inputElementGenerator, minusMenuElement, keyPath: comeFromKeyPath } = this.props, style = getStyle(name, originalValue, keyPath, deep, dataType), isReadOnly = readOnly(name, originalValue, keyPath, deep, dataType), isEditing = editEnabled && !isReadOnly, inputElement = inputElementGenerator(VALUE, comeFromKeyPath, deep, name, originalValue, dataType), editButtonElementLayout = (0, import_react24.cloneElement)(editButtonElement, { onClick: this.handleEdit }), cancelButtonElementLayout = (0, import_react24.cloneElement)(cancelButtonElement, { onClick: this.handleCancelEdit }), inputElementLayout = (0, import_react24.cloneElement)(inputElement, { ref: this.refInput, defaultValue: JSON.stringify(originalValue) }), minusMenuLayout = (0, import_react24.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: style.minus });
    return import_react24.default.createElement("li", { className: "rejt-value-node", style: style.li }, import_react24.default.createElement("span", { className: "rejt-name", style: style.name }, name, " : "), isEditing ? import_react24.default.createElement("span", { className: "rejt-edit-form", style: style.editForm }, inputElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout) : import_react24.default.createElement("span", { className: "rejt-value", style: style.value, onClick: isReadOnly ? null : this.handleEditMode }, String(value2)), !isReadOnly && !isEditing && minusMenuLayout);
  }
};
JsonValue.defaultProps = { keyPath: [], deep: 0, handleUpdateValue: () => Promise.resolve(), editButtonElement: import_react24.default.createElement("button", null, "e"), cancelButtonElement: import_react24.default.createElement("button", null, "c"), minusMenuElement: import_react24.default.createElement("span", null, " - ") };
...
var JsonTree = class extends import_react23.Component {
  constructor(props) {
...
} }, onSubmitValueParser: (isEditMode, keyPath, deep, name, rawValue) => parse3(rawValue), inputElement: () => import_react23.default.createElement("input", null), textareaElement: () => import_react23.default.createElement("textarea", null), fallback: null };
...
var ObjectControl = ({ name, value: value2, onChange }) => {
  let theme = useTheme(), data = (0, import_react22.useMemo)(() => value2 && (0, import_cloneDeep.default)(value2), [value2]), hasData = data != null, [showRaw, setShowRaw] = (0, import_react22.useState)(!hasData), [parseError, setParseError] = (0, import_react22.useState)(null), updateRaw = (0, import_react22.useCallback)((raw) => {
    try {
      raw && onChange(JSON.parse(raw)), setParseError(void 0);
    } catch (e) {
      setParseError(e);
    }
  }, [onChange]), [forceVisible, setForceVisible] = (0, import_react22.useState)(false), onForceVisible = (0, import_react22.useCallback)(() => {
    onChange({}), setForceVisible(true);
  }, [setForceVisible]), htmlElRef = (0, import_react22.useRef)(null);
  if ((0, import_react22.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]), !hasData)
    return import_react22.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
  let rawJSONForm = import_react22.default.createElement(RawInput, { ref: htmlElRef, id: getControlId(name), name, defaultValue: value2 === null ? "" : JSON.stringify(value2, null, 2), onBlur: (event) => updateRaw(event.target.value), placeholder: "Edit JSON string...", autoFocus: forceVisible, valid: parseError ? "error" : null });
  return import_react22.default.createElement(Wrapper5, null, ["Object", "Array"].includes(getObjectType(data)) && import_react22.default.createElement(RawButton, { href: "#", onClick: (e) => {
    e.preventDefault(), setShowRaw((v2) => !v2);
  } }, import_react22.default.createElement(Icons, { icon: showRaw ? "eyeclose" : "eye" }), import_react22.default.createElement("span", null, "RAW")), showRaw ? rawJSONForm : import_react22.default.createElement(JsonTree, { data, rootName: name, onFullyUpdate: onChange, getStyle: getCustomStyleFunction(theme), cancelButtonElement: import_react22.default.createElement(Button, { type: "button" }, "Cancel"), editButtonElement: import_react22.default.createElement(Button, { type: "submit" }, "Save"), addButtonElement: import_react22.default.createElement(Button, { type: "submit", primary: true }, "Save"), plusMenuElement: import_react22.default.createElement(ActionIcon, { icon: "add" }), minusMenuElement: import_react22.default.createElement(ActionIcon, { icon: "subtract" }), inputElement: (_, __, ___, key) => key ? import_react22.default.createElement(Input, { onFocus: selectValue, onBlur: dispatchEnterKey }) : import_react22.default.createElement(Input, null), fallback: rawJSONForm }));
};
...
var RangeControl = ({ name, value: value2, onChange, min = 0, max = 100, step = 1, onBlur, onFocus }) => {
  ...
  }, hasValue = value2 !== void 0, numberOFDecimalsPlaces = (0, import_react25.useMemo)(() => getNumberOfDecimalPlaces(step), [step]);
  return import_react25.default.createElement(RangeWrapper, null, import_react25.default.createElement(RangeLabel, null, min), import_react25.default.createElement(RangeInput, { id: getControlId(name), type: "range", onChange: handleChange, name, value: value2, min, max, step, onFocus, onBlur }), import_react25.default.createElement(RangeCurrentAndMaxLabel, { numberOFDecimalsPlaces, max }, `${hasValue ? value2.toFixed(numberOFDecimalsPlaces) : "--"}`, " / ", max));
};
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength }) => {
  ...
  }, [forceVisible, setForceVisible] = (0, import_react26.useState)(false), onForceVisible = (0, import_react26.useCallback)(() => {
    onChange(""), setForceVisible(true);
  }, [setForceVisible]);
  if (value2 === void 0)
    return import_react26.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
  let isValid = typeof value2 == "string";
  return import_react26.default.createElement(Wrapper6, null, import_react26.default.createElement(Form.Textarea, { id: getControlId(name), maxLength, onChange: handleChange, size: "flex", placeholder: "Edit string...", autoFocus: forceVisible, valid: isValid ? null : "error", name, value: isValid ? value2 : "", onFocus, onBlur }), maxLength && import_react26.default.createElement(MaxLength, { isMaxed: (value2 == null ? void 0 : value2.length) === maxLength }, (value2 == null ? void 0 : value2.length) ?? 0, " / ", maxLength));
};
...
var LazyColorControl = (0, import_react14.lazy)(() => import("./Color-3YIJY6X7-FMDF3C36.js"));
var ColorControl = (props) => import_react14.default.createElement(import_react14.Suspense, { fallback: import_react14.default.createElement("div", null) }, import_react14.default.createElement(LazyColorControl, { ...props }));
...
var NoControl = () => import_react13.default.createElement(import_react13.default.Fragment, null, "-");
var ArgControl = ({ row, arg, updateArgs }) => {
  let { key, control } = row, [isFocused, setFocused] = (0, import_react13.useState)(false), [boxedValue, setBoxedValue] = (0, import_react13.useState)({ value: arg });
  (0, import_react13.useEffect)(() => {
    isFocused || setBoxedValue({ value: arg });
  }, [isFocused, arg]);
  let onChange = (0, import_react13.useCallback)((argVal) => (setBoxedValue({ value: argVal }), updateArgs({ [key]: argVal }), argVal), [updateArgs, key]), onBlur = (0, import_react13.useCallback)(() => setFocused(false), []), onFocus = (0, import_react13.useCallback)(() => setFocused(true), []);
  if (!control || control.disable)
    return import_react13.default.createElement(NoControl, null);
  let props = { name: key, argType: row, value: boxedValue.value, onChange, onBlur, onFocus }, Control = Controls2[control.type] || NoControl;
  return import_react13.default.createElement(Control, { ...props, ...control, controlType: control.type });
};
...
var ArgRow = (props) => {
  ...
  return import_react10.default.createElement("tr", null, import_react10.default.createElement(StyledTd, { expandable }, import_react10.default.createElement(Name, null, name), required ? import_react10.default.createElement(Required, { title: "Required" }, "*") : null), compact ? null : import_react10.default.createElement("td", null, hasDescription && import_react10.default.createElement(Description, null, import_react10.default.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react10.default.createElement(import_react10.default.Fragment, null, import_react10.default.createElement(TypeWithJsDoc, { hasDescription }, import_react10.default.createElement(ArgValue, { value: type, initialExpandedArgs })), import_react10.default.createElement(ArgJsDoc, { tags: table.jsDocTags })) : import_react10.default.createElement(Type, { hasDescription }, import_react10.default.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact ? null : import_react10.default.createElement("td", null, import_react10.default.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? import_react10.default.createElement("td", null, import_react10.default.createElement(ArgControl, { ...props })) : null);
};
...
var SectionRow = ({ level = "section", label, children, initialExpanded = true, colSpan = 3 }) => {
  let [expanded, setExpanded] = (0, import_react28.useState)(initialExpanded), Level = level === "subsection" ? Subsection : Section, itemCount = (children == null ? void 0 : children.length) || 0, caption = level === "subsection" ? `${itemCount} item${itemCount !== 1 ? "s" : ""}` : "", icon = expanded ? "arrowdown" : "arrowright", helperText = `${expanded ? "Hide" : "Show"} ${level === "subsection" ? itemCount : label} item${itemCount !== 1 ? "s" : ""}`;
  return import_react28.default.createElement(import_react28.default.Fragment, null, import_react28.default.createElement(StyledTr, { title: helperText }, import_react28.default.createElement(Level, { colSpan: 1 }, import_react28.default.createElement(ClickIntercept, { onClick: (e) => setExpanded(!expanded), tabIndex: 0 }, helperText), import_react28.default.createElement(FlexWrapper, null, import_react28.default.createElement(ExpanderIcon, { icon }), label)), import_react28.default.createElement(StyledTd2, { colSpan: colSpan - 1 }, import_react28.default.createElement(ClickIntercept, { onClick: (e) => setExpanded(!expanded), tabIndex: -1, style: { outline: "none" } }, helperText), expanded ? null : caption)), expanded ? children : null);
};
...
var ArgsTable = (props) => {
  if ("error" in props)
    return import_react9.default.createElement(EmptyBlock, null, props.error, " ", import_react9.default.createElement(Link2, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  ...
  if (groups.ungrouped.length === 0 && Object.entries(groups.sections).length === 0 && Object.entries(groups.ungroupedSubsections).length === 0)
    return import_react9.default.createElement(EmptyBlock, null, "No inputs found for this component. ", import_react9.default.createElement(Link2, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  let colSpan = 1;
  ...
  return import_react9.default.createElement(ResetWrapper, null, import_react9.default.createElement(TableWrapper, { "aria-hidden": isLoading, compact, inAddonPanel, isLoading, className: "docblock-argstable sb-unstyled" }, import_react9.default.createElement("thead", { className: "docblock-argstable-head" }, import_react9.default.createElement("tr", null, import_react9.default.createElement("th", null, import_react9.default.createElement("span", null, "Name")), compact ? null : import_react9.default.createElement("th", null, import_react9.default.createElement("span", null, "Description")), compact ? null : import_react9.default.createElement("th", null, import_react9.default.createElement("span", null, "Default")), updateArgs ? import_react9.default.createElement("th", null, import_react9.default.createElement(ControlHeadingWrapper, null, "Control", " ", !isLoading && resetArgs && import_react9.default.createElement(StyledIconButton, { onClick: () => resetArgs(), title: "Reset controls" }, import_react9.default.createElement(Icons, { icon: "undo", "aria-hidden": true })))) : null)), import_react9.default.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => import_react9.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(groups.ungroupedSubsections).map(([subcategory, subsection]) => import_react9.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map((row) => import_react9.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], expandable, ...common })))), Object.entries(groups.sections).map(([category, section]) => import_react9.default.createElement(SectionRow, { key: category, label: category, level: "section", colSpan }, section.ungrouped.map((row) => import_react9.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(section.subsections).map(([subcategory, subsection]) => import_react9.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map((row) => import_react9.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], expandable, ...common })))))))));
};
var TabbedArgsTable = ({ tabs, ...props }) => {
  let entries = Object.entries(tabs);
  return entries.length === 1 ? import_react29.default.createElement(ArgsTable, { ...entries[0][1], ...props }) : import_react29.default.createElement(TabsState, null, entries.map((entry) => {
    let [label, table] = entry, id = `prop_table_div_${label}`;
    return import_react29.default.createElement("div", { key: id, id, title: label }, ({ active }) => active ? import_react29.default.createElement(ArgsTable, { key: `prop_table_${label}`, ...table, ...props }) : null);
  }));
};
...
var NoControlsWarning = () => import_react30.default.createElement(NoControlsWrapper, null, "This story is not configured to handle controls.", " ", import_react30.default.createElement(Link2, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", cancel: false, withArrow: true }, "Learn how to add controls"));
...
var Typeset = ({ fontFamily, fontSizes, fontWeight, sampleText, ...props }) => import_react31.default.createElement(Wrapper7, { ...props, className: "docblock-typeset sb-unstyled" }, fontSizes.map((size) => import_react31.default.createElement(TypeSpecimen, { key: size }, import_react31.default.createElement(Label4, null, size), import_react31.default.createElement(Sample, { style: { fontFamily, fontSize: size, fontWeight, lineHeight: 1.2 } }, sampleText || "Was he a beast if music could move him so?"))));
...
function renderSwatch(color, index) {
  return import_react32.default.createElement(Swatch, { key: `${color}-${index}`, title: color, background: color });
}
function renderSwatchLabel(color, index, colorDescription) {
  return import_react32.default.createElement(SwatchLabel, { key: `${color}-${index}`, title: color }, import_react32.default.createElement("div", null, color, colorDescription && import_react32.default.createElement("span", null, colorDescription)));
}
function renderSwatchSpecimen(colors) {
  return Array.isArray(colors) ? import_react32.default.createElement(SwatchSpecimen, null, import_react32.default.createElement(SwatchColors, null, colors.map((color, index) => renderSwatch(color, index))), import_react32.default.createElement(SwatchLabels, null, colors.map((color, index) => renderSwatchLabel(color, index)))) : import_react32.default.createElement(SwatchSpecimen, null, import_react32.default.createElement(SwatchColors, null, Object.values(colors).map((color, index) => renderSwatch(color, index))), import_react32.default.createElement(SwatchLabels, null, Object.keys(colors).map((color, index) => renderSwatchLabel(color, index, colors[color]))));
}
...
var IconItem = ({ name, children }) => import_react33.default.createElement(Item2, null, import_react33.default.createElement(ItemSpecimen, null, children), import_react33.default.createElement(ItemLabel, null, name));
var IconGallery = ({ children, ...props }) => import_react33.default.createElement(ResetWrapper, null, import_react33.default.createElement(List2, { ...props, className: "docblock-icongallery sb-unstyled" }, children));
var anchorBlockIdFromId = (storyId) => `anchor--${storyId}`;
var Anchor = ({ storyId, children }) => import_react34.default.createElement("div", { id: anchorBlockIdFromId(storyId), className: "sb-anchor" }, children);
scope && scope.__DOCS_CONTEXT__ === void 0 && (scope.__DOCS_CONTEXT__ = (0, import_react37.createContext)(null), scope.__DOCS_CONTEXT__.displayName = "DocsContext");
var DocsContext = scope ? scope.__DOCS_CONTEXT__ : (0, import_react37.createContext)(null);
var useOf = (moduleExportOrType, validTypes) => (0, import_react36.useContext)(DocsContext).resolveOf(moduleExportOrType, validTypes);
...
var ArgTypes = (props) => {
  ...
  let resolved = useOf(of || "meta"), { argTypes, parameters } = getArgTypesFromResolved(resolved, props), argTypesParameters = ((_a = parameters.docs) == null ? void 0 : _a.argTypes) || {}, include = props.include ?? argTypesParameters.include, exclude = props.exclude ?? argTypesParameters.exclude, sort = props.sort ?? argTypesParameters.sort, filteredArgTypes = (0, import_preview_api2.filterArgTypes)(argTypes, include, exclude);
  return import_react35.default.createElement(ArgsTable, { rows: filteredArgTypes, sort });
};
var PRIMARY_STORY = "^";
...
function useStories(storyIds, context) {
  let [storiesById, setStories] = (0, import_react39.useState)({});
...
var useArgs = (storyId, context) => {
  let storyContext = context.getStoryContext(context.storyById()), [args, setArgs] = (0, import_react38.useState)(storyContext.args);
  ...
  let updateArgs = (0, import_react38.useCallback)((updatedArgs) => context.channel.emit(import_core_events.UPDATE_STORY_ARGS, { storyId, updatedArgs }), [storyId]), resetArgs = (0, import_react38.useCallback)((argNames) => context.channel.emit(import_core_events.RESET_STORY_ARGS, { storyId, argNames }), [storyId]);
  return [args, updateArgs, resetArgs];
};
var useGlobals = (context) => {
  let storyContext = context.getStoryContext(context.storyById()), [globals, setGlobals] = (0, import_react38.useState)(storyContext.globals);
...
var extractComponentArgTypes2 = (component, parameters, include, exclude) => {
  ...
  return argTypes = (0, import_preview_api3.filterArgTypes)(argTypes, include, exclude), argTypes;
};
...
var StoryTable = (props) => {
  let context = (0, import_react38.useContext)(DocsContext), { story: storyName, component, subcomponents, showComponent, include, exclude, sort } = props;
  try {
    let storyId;
    switch (storyName) {
      case PRIMARY_STORY: {
    ...
    if (!story)
      return import_react38.default.createElement(ArgsTable, { isLoading: true, updateArgs, resetArgs });
    let argTypes = (0, import_preview_api3.filterArgTypes)(story.argTypes, include, exclude), mainLabel = getComponentName(component) || "Story", tabs = { [mainLabel]: { rows: argTypes, args, globals, updateArgs, resetArgs } }, storyHasArgsWithControls = argTypes && Object.values(argTypes).find((v2) => !!(v2 == null ? void 0 : v2.control));
    ...
    return import_react38.default.createElement(TabbedArgsTable, { tabs, sort });
  } catch (err) {
    return import_react38.default.createElement(ArgsTable, { error: err.message });
  }
};
...
var ArgsTable2 = (props) => {
  var _a;
  (0, import_client_logger5.deprecate)(esm_default`The ArgsTable doc block is deprecated. Instead use the ArgTypes doc block for static tables or the Controls doc block for tables with controls.
    
  Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#argstable-block
  `);
  let context = (0, import_react38.useContext)(DocsContext), parameters, component, subcomponents;
  try {
  ...
  if (storyName)
    return import_react38.default.createElement(StoryTable, { ...props, component: main, subcomponents, sort });
  if (!components22 && !subcomponents) {
    ...
    return import_react38.default.createElement(ArgsTable, { ...mainProps, sort });
  }
  if (components22)
    return import_react38.default.createElement(ComponentsTable, { ...props, components: components22, sort, parameters });
  let mainLabel = getComponentName(main);
  return import_react38.default.createElement(ComponentsTable, { ...props, components: { [mainLabel]: main, ...subcomponents }, sort, parameters });
};
ArgsTable2.defaultProps = { of: PRIMARY_STORY };
function argsHash(args) {
  return stringify(args);
}
var SourceContext = (0, import_react41.createContext)({ sources: {} });
var UNKNOWN_ARGS_HASH = "--unknown--";
var SourceContainer = ({ children, channel }) => {
  let [sources, setSources] = (0, import_react41.useState)({});
  ...
  }, []), import_react41.default.createElement(SourceContext.Provider, { value: { sources } }, children);
};
...
var useArgsIfDefined = (story, context) => {
  let storyContext = story ? context.getStoryContext(story) : { args: {} }, { id: storyId } = story || { id: "none" }, [args, setArgs] = (0, import_react43.useState)(storyContext.args);
  ...
  let updateArgs = (0, import_react43.useCallback)((updatedArgs) => context.channel.emit(import_core_events2.UPDATE_STORY_ARGS, { storyId, updatedArgs }), [storyId, context.channel]), resetArgs = (0, import_react43.useCallback)((argNames) => context.channel.emit(import_core_events2.RESET_STORY_ARGS, { storyId, argNames }), [storyId, context.channel]);
...
var getSnippet = ({ snippet, storyContext, typeFromProps, transformFromProps }) => {
  ...
  return sourceParameters.transformSource && (0, import_client_logger7.deprecate)(esm_default`The \`transformSource\` parameter at \`parameters.docs.source.transformSource\` is deprecated, please use \`parameters.docs.source.transform\` instead. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#source-block
  `), ((_b = storyContext.parameters.docs) == null ? void 0 : _b.transformSource) && (0, import_client_logger7.deprecate)(esm_default`The \`transformSource\` parameter at \`parameters.docs.transformSource\` is deprecated, please use \`parameters.docs.source.transform\` instead. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#source-block
  `), ((_c = storyContext.parameters.jsx) == null ? void 0 : _c.transformSource) && (0, import_client_logger7.deprecate)(esm_default`The \`transformSource\` parameter at \`parameters.jsx.transformSource\` is deprecated, please use \`parameters.docs.source.transform\` instead. 
...
var useSourceProps = (props, docsContext, sourceContext) => {
  ...
  code || (code = stories.map((story, index) => {
    ...
    if (!story)
      return "";
    let [args] = argsFromStories[index] || [], storyContext = docsContext.getStoryContext(story), argsForSource = props.__forceInitialArgs ? storyContext.initialArgs : args, source = getStorySource(story.id, argsForSource, sourceContext);
...
var Source2 = (props) => {
  props.id && (0, import_client_logger7.deprecate)(esm_default`The \`id\` prop on Source is deprecated, please use the \`of\` prop instead to reference a story. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#source-block
  `), props.ids && (0, import_client_logger7.deprecate)(esm_default`The \`ids\` prop on Source is deprecated, please use the \`of\` prop instead to reference a story. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#source-block
  `);
  let sourceContext = (0, import_react42.useContext)(SourceContext), docsContext = (0, import_react42.useContext)(DocsContext), { state, ...sourceProps } = useSourceProps(props, docsContext, sourceContext);
  return import_react42.default.createElement(Source, { ...sourceProps });
};
var getStoryId2 = (props, context) => {
  ...
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  if (id)
    return (0, import_client_logger8.deprecate)(esm_default`Referencing stories by \`id\` is deprecated, please use \`of\` instead. 
    
      Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#story-block'`), id;
  let { name } = props;
  return name ? ((0, import_client_logger8.deprecate)(esm_default`Referencing stories by \`name\` is deprecated, please use \`of\` instead. 
    
      Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#story-block'`), context.storyIdByName(name)) : (story && (0, import_client_logger8.deprecate)(esm_default`The \`story\` prop is deprecated, please export your stories from CSF files and reference them with \`of={}\`.
...
var getStoryProps = (props, story, context) => {
  ...
  typeof inlineStories < "u" && (0, import_client_logger8.deprecate)(esm_default`The \`docs.inlineStories\` parameter is deprecated, use \`docs.story.inline\` instead. 
    
      Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#autodocs-changes'
    `);
  let inline = props.inline ?? storyParameters.inline ?? inlineStories ?? false;
  if (typeof iframeHeight < "u" && (0, import_client_logger8.deprecate)(esm_default`The \`docs.iframeHeight\` parameter is deprecated, use \`docs.story.iframeHeight\` instead. 
...
var Story2 = (props = { __forceInitialArgs: false, __primary: false }) => {
  let context = (0, import_react44.useContext)(DocsContext), storyId = getStoryId2(props, context), story = useStory(storyId, context);
  if (!story)
    return import_react44.default.createElement(StorySkeleton, null);
  let storyProps = getStoryProps(props, story, context);
  return storyProps ? import_react44.default.createElement(Story, { ...storyProps }) : null;
};
var useDeprecatedPreviewProps = ({ withSource, mdxSource, children, layout: layoutProp, ...props }, docsContext, sourceContext) => {
  let storyIds = import_react40.Children.toArray(children).filter((c) => c.props && (c.props.id || c.props.name || c.props.of)).map((c) => getStoryId2(c.props, docsContext)), stories = useStories(storyIds, docsContext), isLoading = stories.some((s) => !s), sourceProps = useSourceProps({ ...mdxSource ? { code: decodeURI(mdxSource) } : { ids: storyIds }, ...props.of && { of: props.of } }, docsContext, sourceContext);
  if (withSource === "none")
...
var Canvas = (props) => {
  ...
  let docsContext = (0, import_react40.useContext)(DocsContext), sourceContext = (0, import_react40.useContext)(SourceContext), { children, of, source } = props;
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  ...
  if (hookError)
    throw hookError;
  if (props.withSource && (0, import_client_logger6.deprecate)(esm_default`Setting source state with \`withSource\` is deprecated, please use \`sourceState\` with 'hidden', 'shown' or 'none' instead. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
    `), props.mdxSource && (0, import_client_logger6.deprecate)(esm_default`Setting source code with \`mdxSource\` is deprecated, please use source={{code: '...'}} instead. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
    `), (props.isColumn !== void 0 || props.columns !== void 0) && (0, import_client_logger6.deprecate)(esm_default`\`isColumn\` and \`columns\` props are deprecated as the Canvas block now only supports showing a single story. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
    `), children)
    return (0, import_client_logger6.deprecate)(esm_default`Passing children to Canvas is deprecated, please use the \`of\` prop instead to reference a story. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
  `), isLoading ? import_react40.default.createElement(PreviewSkeleton, null) : import_react40.default.createElement(Preview, { ...previewProps }, children);
  ...
  return import_react40.default.createElement(Preview, { withSource: sourceState === "none" ? void 0 : sourceProps, isExpanded: sourceState === "shown", withToolbar, additionalActions, className, layout }, import_react40.default.createElement(Story2, { of: of || story.moduleExport, meta: props.meta, ...props.story }));
};
var useGlobals2 = (story, context) => {
  let storyContext = context.getStoryContext(story), [globals, setGlobals] = (0, import_react46.useState)(storyContext.globals);
...
var Controls3 = (props) => {
  ...
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let context = (0, import_react45.useContext)(DocsContext), { story } = context.resolveOf(of || "story", ["story"]), { parameters, argTypes } = story, controlsParameters = ((_a = parameters.docs) == null ? void 0 : _a.controls) || {}, include = props.include ?? controlsParameters.include, exclude = props.exclude ?? controlsParameters.exclude, sort = props.sort ?? controlsParameters.sort, [args, updateArgs, resetArgs] = useArgs2(story, context), [globals] = useGlobals2(story, context), filteredArgTypes = (0, import_preview_api4.filterArgTypes)(argTypes, include, exclude);
  return import_react45.default.createElement(ArgsTable, { rows: filteredArgTypes, args, globals, updateArgs, resetArgs, sort });
};
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = import_react49.default.useContext(DocsContext);
  return import_react49.default.createElement(DocsContext.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react49.default.createElement(Code, null, children);
  let language = className && className.split("-");
  return import_react49.default.createElement(Source, { language: language && language[1] || "plaintext", format: false, code: children, ...rest });
};
...
var AnchorInPage = ({ hash, children }) => {
  let context = (0, import_react49.useContext)(DocsContext);
  return import_react49.default.createElement(A, { href: hash, target: "_self", onClick: (event) => {
    let id = hash.substring(1);
    document2.getElementById(id) && navigate(context, hash);
  } }, children);
};
var AnchorMdx = (props) => {
  let { href, target, children, ...rest } = props, context = (0, import_react49.useContext)(DocsContext);
  if (href) {
    if (href.startsWith("#"))
      return import_react49.default.createElement(AnchorInPage, { hash: href }, children);
    if (target !== "_blank" && !href.startsWith("https://"))
      return import_react49.default.createElement(A, { href, onClick: (event) => {
  ...
  return import_react49.default.createElement(A, { ...props });
};
...
var HeaderWithOcticonAnchor = ({ as, id, children, ...rest }) => {
  let context = (0, import_react49.useContext)(DocsContext), OcticonHeader = OcticonHeaders[as], hash = `#${id}`;
  return import_react49.default.createElement(OcticonHeader, { id, ...rest }, import_react49.default.createElement(OcticonAnchor, { "aria-hidden": "true", href: hash, tabIndex: -1, target: "_self", onClick: (event) => {
    document2.getElementById(id) && navigate(context, hash);
  } }, import_react49.default.createElement(Icons, { icon: "link" })), children);
};
var HeaderMdx = (props) => {
  let { as, id, children, ...rest } = props;
  if (id)
    return import_react49.default.createElement(HeaderWithOcticonAnchor, { as, id, ...rest }, children);
  let Component42 = as, { as: omittedAs, ...withoutAs } = props;
  return import_react49.default.createElement(Component42, { ...nameSpaceClassNames(withoutAs, as) });
};
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce((acc, headerType) => ({ ...acc, [headerType]: (props) => import_react49.default.createElement(HeaderMdx, { as: headerType, ...props }) }), {});
var Markdown2 = (props) => {
  var _a;
  if (!props.children)
    return null;
  if (typeof props.children != "string")
    throw new Error(esm_default`The Markdown block only accepts children as a single string, but children were of type: '${typeof props.children}'
      ...
      `);
  return import_react48.default.createElement(index_modern_default, { ...props, options: { forceBlock: true, overrides: { code: CodeOrSourceMdx, a: AnchorMdx, ...HeadersMdx, ...(_a = props == null ? void 0 : props.options) == null ? void 0 : _a.overrides }, ...props == null ? void 0 : props.options } });
};
...
var getDescriptionFromDeprecatedProps = ({ type, markdown, children }, { storyById }) => {
  ...
  (Boolean(notes) || Boolean(info)) && (0, import_client_logger9.deprecate)(`Using 'parameters.notes' or 'parameters.info' properties to describe stories is deprecated. See ${DEPRECATION_MIGRATION_LINK}`);
...
var DescriptionContainer = (props) => {
  ...
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let context = (0, import_react47.useContext)(DocsContext), resolvedOf = useOf(of || "meta"), markdown;
  return type || markdownProp || children ? markdown = getDescriptionFromDeprecatedProps(props, context) : markdown = getDescriptionFromResolvedOf(resolvedOf), type && (0, import_client_logger9.deprecate)(`Manually specifying description type is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), markdownProp && (0, import_client_logger9.deprecate)(`The 'markdown' prop on the Description block is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), children && (0, import_client_logger9.deprecate)(`The 'children' prop on the Description block is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), markdown ? import_react47.default.createElement(Markdown2, null, markdown) : null;
};
var { document: document3, window: globalWindow3 } = scope;
var DocsContainer = ({ context, theme, children }) => ((0, import_react51.useEffect)(() => {
  let url;
  try {
...
}), import_react51.default.createElement(DocsContext.Provider, { value: context }, import_react51.default.createElement(SourceContainer, { channel: context.channel }, import_react51.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react51.default.createElement(DocsPageWrapper, null, children)))));
...
var Title2 = ({ children }) => {
  let context = (0, import_react53.useContext)(DocsContext), content = children || extractTitle(context.storyById().title);
  return content ? import_react53.default.createElement(Title, { className: "sbdocs-title sb-unstyled" }, content) : null;
};
var Subtitle2 = ({ children }) => {
  let docsContext = (0, import_react54.useContext)(DocsContext), { parameters } = docsContext.storyById(), content = children || (parameters == null ? void 0 : parameters.componentSubtitle);
  return content ? import_react54.default.createElement(Subtitle, { className: "sbdocs-subtitle sb-unstyled" }, content) : null;
};
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react57.default.createElement(H3, null, children);
  let tagID = children.toLowerCase().replace(/[^a-z0-9]/gi, "-");
  return import_react57.default.createElement(HeaderMdx, { as: "h3", id: tagID }, children);
};
var DocsStory = ({ of, expanded = true, withToolbar: withToolbarProp = false, __forceInitialArgs = false, __primary = false }) => {
  ...
  return import_react56.default.createElement(Anchor, { storyId: story.id }, expanded && import_react56.default.createElement(import_react56.default.Fragment, null, import_react56.default.createElement(Subheading, null, story.name), import_react56.default.createElement(DescriptionContainer, { of })), import_react56.default.createElement(Canvas, { of, withToolbar, story: { __forceInitialArgs, __primary }, source: { __forceInitialArgs } }));
};
var Primary = ({ name }) => {
  let docsContext = (0, import_react55.useContext)(DocsContext);
  name && (0, import_client_logger10.deprecate)(esm_default`\`name\` prop is deprecated on the Primary block.
    The Primary block should only be used to render the primary story, which is automatically found.
    `);
  let storyId = name && docsContext.storyIdByName(name), story = docsContext.storyById(storyId);
  return story ? import_react55.default.createElement(DocsStory, { of: story.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
...
var Stories = ({ title, includePrimary = true }) => {
  let { componentStories } = (0, import_react58.useContext)(DocsContext), stories = componentStories().filter((story) => {
    var _a, _b;
    return !((_b = (_a = story.parameters) == null ? void 0 : _a.docs) == null ? void 0 : _b.disable);
  });
  return includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : import_react58.default.createElement(import_react58.default.Fragment, null, import_react58.default.createElement(StyledHeading, null, title), stories.map((story) => story && import_react58.default.createElement(DocsStory, { key: story.id, of: story.moduleExport, expanded: true, __forceInitialArgs: true })));
};
...
var DocsPage = () => {
  ...
  return import_react52.default.createElement(import_react52.default.Fragment, null, import_react52.default.createElement(Title2, null), import_react52.default.createElement(Subtitle2, null), import_react52.default.createElement(DescriptionContainer, { of: "meta" }), isSingleStory ? import_react52.default.createElement(DescriptionContainer, { of: "story" }) : null, import_react52.default.createElement(Primary, null), import_react52.default.createElement(Controls3, null), isSingleStory ? null : import_react52.default.createElement(Stories, null));
};
var Docs = ({ docsParameter, context }) => {
  let Container = docsParameter.container || DocsContainer, Page = docsParameter.page || DocsPage;
  return import_react50.default.createElement(Container, { context, theme: docsParameter.theme }, import_react50.default.createElement(Page, null));
};
...
var ExternalPreview = class extends import_preview_api6.Preview {
  constructor(projectAnnotations) {
    ...
    this.initialize({ getStoryIndex: () => this.storyIndex, importFn: (path) => Promise.resolve(this.moduleExportsByImportPath[path]), getProjectAnnotations: () => (0, import_preview_api6.composeConfigs)([{ parameters: { docs: { story: { inline: true } } } }, this.projectAnnotations]) });
  }
};
function usePreview(projectAnnotations) {
  let previewRef = (0, import_react60.useRef)();
...
var ExternalDocs = ({ projectAnnotationsList, children }) => {
  var _a;
  let projectAnnotations = (0, import_preview_api5.composeConfigs)(projectAnnotationsList), preview2 = usePreview(projectAnnotations), docsParameter = { ...(_a = projectAnnotations.parameters) == null ? void 0 : _a.docs, page: () => children };
  return import_react60.default.createElement(Docs, { docsParameter, context: preview2.docsContext() });
};
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react61.default.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react61.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = (0, import_react62.useContext)(DocsContext);
  of && context.referenceMeta(of, true);
  try {
    let primary = context.storyById();
    return import_react62.default.createElement(Anchor, { storyId: primary.id });
  } catch {
    return null;
  }
};
var Unstyled = (props) => import_react63.default.createElement("div", { ...props, className: "sb-unstyled" });
var Wrapper8 = ({ children }) => import_react64.default.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
...
var WithCallback = ({ callback, children }) => {
  let once2 = (0, import_react65.useRef)();
  return (0, import_react65.useLayoutEffect)(() => {
    once2.current !== callback && (once2.current = callback, callback());
  }, [callback]), children;
};
var renderElement = async (node, el) => {
  let root = await getReactRoot(el);
  return new Promise((resolve) => {
    root.render(import_react65.default.createElement(WithCallback, { callback: () => resolve(null) }, node));
  });
};
...
var ErrorBoundary = class extends import_react66.Component {
  constructor() {
    super(...arguments);
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./@mdx-js_react.js").then(({ MDXProvider }) => renderElement(import_react66.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react66.default.createElement(MDXProvider, { components }, import_react66.default.createElement(Docs, { context, docsParameter }))), element)).then(resolve);
      });
...
//# sourceMappingURL=chunk-64TSVBJJ.js.map
